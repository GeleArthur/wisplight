...
public class ShadowProjector : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localScale = new Vector3(transform.localScale.x, transform.localScale.y, shadowLength + 0.1f);
        transform.position = player.position - new Vector3(0, bounds.size.y / 2f, 0) -
                             new Vector3(0, shadowLength / 2, 0);
